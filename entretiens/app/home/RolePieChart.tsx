...
export default function RolePieChart({ adminCount, userCount, theme = "light" }: { adminCount: number; userCount: number; theme?: 'light' | 'dark' }) {
  ...
  return (
    <div style={{ background: palette.bg, borderRadius: 14, padding: 18, boxShadow: "0 2px 12px #23272f22", minHeight: 260, display: "flex", flexDirection: "column", alignItems: "center", position: "relative" }}>
      <div style={{ color: palette.text, fontWeight: 700, fontSize: 16, marginBottom: 12 }}>Répartition des rôles</div>
      <div style={{ position: "relative", width: 220, height: 220 }}>
        <Doughnut
          ...
          options={{
            plugins: {
              legend: { labels: { color: palette.text, font: { size: 13 } }, position: "bottom" },
              title: { display: false }
            },
            cutout: "70%"
          }}
